export const translations = {
    ...
    en: {
        ...
        home: {
            ...
            cta_enter: 'Enter the House',
            cta_discover: 'Discover our collections',
            manifesto_title: 'The Art of Receiving',
            manifesto_text: 'We orchestrate exceptional moments where gastronomy meets elegance. Each dish is a work of art, each reception a unique experience.',
        ...
        account: {
            ...
            register_subtitle: 'Join us for an exceptional experience',
            email: 'Email',
            password: 'Password',
            confirm_password: 'Confirm Password',
            firstname: 'First Name',
            ...
            success_address_add: 'Address added successfully',
            success_address_update: 'Address updated successfully',
        ...
        cart: {
            ...
            empty_desc: 'Add products to your cart to continue',
        ...
        product: {
            ...
            descriptions: {
                'Symphonie Océane': 'Royal seafood platter: blue lobster, Gillardeau n°2 oysters, royal langoustines, and Osciètre caviar (30g).',
                'L\'Apogée Terroir': 'Chic country buffet: Duck foie gras half-cooked, Pata Negra Bellota ham, aged cheeses.',
                'Le Brunch Impérial': 'Assortment of pastries, Scottish smoked salmon, truffle scrambled eggs, exotic fruit salad.',
                'Soirée Toscane': 'Grilled vegetable antipasti, fine Italian charcuterie, creamy burrata from Puglia, rosemary focaccia.',
                'Le Grand Dîner': 'Roasted Wagyu beef, double cream dauphinois gratin, cep mushrooms, chef\'s dessert selection.',
                'Coffret "Affaires" Premium': 'Dill Gravlax salmon, farm-raised poultry supreme with morels, crushed potatoes.',
                'Coffret Végétal': 'Colored beet carpaccio, spelt risotto with forgotten vegetables, cheese selection.',
                'Coffret Mer & Merveilles': 'Skrei cod fillet, sweet potato mousseline, glazed vegetables, red fruit pavlova.',
                'Bento Fusion': 'Red tuna tataki, wakame seaweed salad, sesame vinegared rice, artisanal ice mochis.',
                'Le "Parisien-Chic"': 'Traditional baguette sandwich with truffled ham, 24-month Comté, lamb\'s lettuce.',
                'Coffret Bien-Être': 'Marinated salmon poke bowl, avocado, mango, red quinoa, green smoothie, fresh fruit salad.',
                'Les Classiques': 'Brioche crab navette, Comté gougère, smoked salmon wrap.',
                'Mini-Burgers': 'Plate of 12 mini-cheeseburgers: Charolais beef, aged cheddar, house sauce.',
                'Verrines Fraîcheur': 'Assortment of 12 verrines: Andalusian gazpacho, cucumber tartare with mint.',
                'Brochettes Soleil': '12 skewers: Mozzarella-Cherry tomato, Melon-Cured ham, Chicken-Pineapple.',
                'Délices Fromagers': '12 pieces: Parmesan shortbread, Roquefort choux, fresh goat roll.',
                'Collection Signature': 'Foie gras opera, goat-fig macaron, tempura prawns.',
                'Saveurs d\'Orient': '12 pieces: Sesame falafels, lamb keftas with mint, cheese briouates.',
                'Mignardises Sucrées': '12 sweet pieces: Mini-éclairs, raspberry tartlets, praline choux.',
                'Terre & Mer': '12 pieces: Pesto beef roll, scallop tartare, salmon blinis.',
                'Atelier Bruschetta': 'Tomato-Basil, Truffle-Ricotta, Zucchini-Mint.',
                'Écrin Deluxe': 'Baeri caviar blinis, truffle scallop carpaccio, lobster in citrus jelly.',
