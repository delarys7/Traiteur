export const translations = {
    fr: {
        ...
        product: {
            ...
            names: {
                'Symphonie Océane': 'Symphonie Océane',
                'L\'Apogée Terroir': 'L\'Apogée Terroir',
                'Le Brunch Impérial': 'Le Brunch Impérial',
                'Soirée Toscane': 'Soirée Toscane',
                'Le Grand Dîner': 'Le Grand Dîner',
                'Coffret "Affaires" Premium': 'Coffret "Affaires" Premium',
                'Coffret Végétal': 'Coffret Végétal',
                'Coffret Mer & Merveilles': 'Coffret Mer & Merveilles',
                'Bento Fusion': 'Bento Fusion',
                'Le "Parisien-Chic"': 'Le "Parisien-Chic"',
                'Coffret Bien-Être': 'Coffret Bien-Être',
                'Les Classiques': 'Les Classiques',
                'Mini-Burgers': 'Mini-Burgers',
                'Verrines Fraîcheur': 'Verrines Fraîcheur',
                'Brochettes Soleil': 'Brochettes Soleil',
                'Délices Fromagers': 'Délices Fromagers',
                'Collection Signature': 'Collection Signature',
                'Saveurs d\'Orient': 'Saveurs d\'Orient',
                'Mignardises Sucrées': 'Mignardises Sucrées',
                'Terre & Mer': 'Terre & Mer',
                'Atelier Bruschetta': 'Atelier Bruschetta',
                'Écrin Deluxe': 'Écrin Deluxe',
                'Le Caviar & Vodka': 'Le Caviar & Vodka',
                'Folie Truffée': 'Folie Truffée',
                'Homard Excellence': 'Homard Excellence',
                'Orfèvrerie Sucrée': 'Orfèvrerie Sucrée',
                'Gigot d\'Agneau Label Rouge': 'Gigot d\'Agneau Label Rouge',
                'Carré d\'Agneau Entier': 'Carré d\'Agneau Entier',
                'Filet de Bœuf Charolais': 'Filet de Bœuf Charolais',
                'Côte de Bœuf Maturée': 'Côte de Bœuf Maturée',
                'Entrecôte Wagyu': 'Entrecôte Wagyu',
                'Rôti de Porc Fermier': 'Rôti de Porc Fermier',
                'Carré de Porc Entier': 'Carré de Porc Entier',
                'Poulet Fermier Label Rouge': 'Poulet Fermier Label Rouge',
                'Suprêmes de Volaille': 'Suprêmes de Volaille',
                'Canard de Challans': 'Canard de Challans',
                'Magret de Canard': 'Magret de Canard',
                'Caille Fermière': 'Caille Fermière'
            },
            descriptions: {
                ...
                'Gigot d\'Agneau Label Rouge': 'Gigot d\'agneau français Label Rouge, 2,5 kg, prêt à rôtir. Viande tendre et savoureuse, idéale pour les grandes occasions.',
                'Carré d\'Agneau Entier': 'Carré d\'agneau premium, 8 côtelettes, 1,8 kg. Viande d\'exception, parfaite pour les réceptions haut de gamme.',
                'Filet de Bœuf Charolais': 'Filet de bœuf Charolais AOC, 1,5 kg. Viande d\'exception, tendre et persillée, sélection premium pour distributeurs de luxe.',
                'Côte de Bœuf Maturée': 'Côte de bœuf maturée 30 jours, 1,2 kg. Affinage optimal pour une saveur incomparable, pièce maîtresse des tables d\'exception.',
                'Entrecôte Wagyu': 'Entrecôte Wagyu A5, 800g. Marbrure exceptionnelle, saveur intense et fondante. Le summum de l\'excellence carnée.',
                'Rôti de Porc Fermier': 'Rôti de porc fermier Label Rouge, 2 kg. Viande savoureuse et juteuse, élevage respectueux, qualité premium.',
                'Carré de Porc Entier': 'Carré de porc fermier, 6 côtelettes, 1,5 kg. Viande tendre et parfumée, sélection premium pour professionnels.',
                'Poulet Fermier Label Rouge': 'Poulet fermier Label Rouge entier, 1,8 kg. Élevé en plein air, chair ferme et savoureuse, qualité d\'exception.',
                'Suprêmes de Volaille': 'Suprêmes de volaille fermière, 1 kg (4 pièces). Viande blanche tendre et juteuse, parfaite pour les préparations raffinées.',
                'Canard de Challans': 'Canard de Challans entier, 2,2 kg. Volaille d\'exception, chair fine et savoureuse, référence gastronomique française.',
                'Magret de Canard': 'Magret de canard fermier, 2 pièces, 600g. Viande persillée et savoureuse, sélection premium pour professionnels.',
                'Caille Fermière': 'Caille fermière entière, 4 pièces, 600g. Volaille fine et délicate, idéale pour les préparations gastronomiques.'
            }
        },
        filters: {
            cuisine: {
    ...
    en: {
        ...
        product: {
            ...
            names: {
                'Symphonie Océane': 'Ocean Symphony',
                'L\'Apogée Terroir': 'The Zenith of Terroir',
                'Le Brunch Impérial': 'The Imperial Brunch',
                'Soirée Toscane': 'Tuscan Evening',
                'Le Grand Dîner': 'The Grand Dinner',
                'Coffret "Affaires" Premium': 'Premium "Business" Box',
                'Coffret Végétal': 'Veggie Box',
                'Coffret Mer & Merveilles': 'Sea & Wonders Box',
                'Bento Fusion': 'Fusion Bento',
                'Le "Parisien-Chic"': '"Parisian-Chic"',
                'Coffret Bien-Être': 'Wellness Box',
                'Les Classiques': 'The Classics',
                'Mini-Burgers': 'Mini-Burgers',
                'Verrines Fraîcheur': 'Freshness Verrines',
                'Brochettes Soleil': 'Sun Skewers',
                'Délices Fromagers': 'Cheese Delights',
                'Collection Signature': 'Signature Collection',
                'Saveurs d\'Orient': 'Eastern Flavors',
                'Mignardises Sucrées': 'Sweet Petits Fours',
                'Terre & Mer': 'Land & Sea',
                'Atelier Bruschetta': 'Bruschetta Workshop',
                'Écrin Deluxe': 'Deluxe Case',
                'Le Caviar & Vodka': 'Caviar & Vodka',
                'Folie Truffée': 'Truffle Madness',
                'Homard Excellence': 'Lobster Excellence',
                'Orfèvrerie Sucrée': 'Sweet Jewels',
                'Gigot d\'Agneau Label Rouge': 'Label Rouge Leg of Lamb',
                'Carré d\'Agneau Entier': 'Whole Rack of Lamb',
                'Filet de Bœuf Charolais': 'Charolais Beef Fillet',
                'Côte de Bœuf Maturée': 'Aged Rib of Beef',
                'Entrecôte Wagyu': 'Wagyu Ribeye',
                'Rôti de Porc Fermier': 'Farm-Raised Roast Pork',
                'Carré de Porc Entier': 'Whole Rack of Pork',
                'Poulet Fermier Label Rouge': 'Label Rouge Farm Chicken',
                'Suprêmes de Volaille': 'Poultry Supremes',
                'Canard de Challans': 'Challans Duck',
                'Magret de Canard': 'Duck Breast',
                'Caille Fermière': 'Farm-Raised Quail'
            },
            descriptions: {
                ...
                'Gigot d\'Agneau Label Rouge': 'French Label Rouge leg of lamb, 2.5 kg, ready to roast. Tender and flavorful meat, ideal for special occasions.',
                'Carré d\'Agneau Entier': 'Premium rack of lamb, 8 cutlets, 1.8 kg. Exceptional meat, perfect for high-end receptions.',
                'Filet de Bœuf Charolais': 'Charolais PDO beef fillet, 1.5 kg. Exceptional meat, tender and marbled, premium selection for luxury distributors.',
                'Côte de Bœuf Maturée': 'Beef rib aged for 30 days, 1.2 kg. Optimal aging for incomparable flavor, centerpiece for exceptional tables.',
                'Entrecôte Wagyu': 'Wagyu A5 ribeye, 800g. Exceptional marbling, intense and melting flavor. The pinnacle of meat excellence.',
                'Rôti de Porc Fermier': 'Label Rouge farm-raised roast pork, 2 kg. Flavorful and juicy meat, respectful farming, premium quality.',
                'Carré de Porc Entier': 'Farm-raised rack of pork, 6 cutlets, 1.5 kg. Tender and fragrant meat, premium selection for professionals.',
                'Poulet Fermier Label Rouge': 'Whole Label Rouge farm chicken, 1.8 kg. Free-range, firm and flavorful flesh, exceptional quality.',
                'Suprêmes de Volaille': 'Farm-raised poultry supremes, 1 kg (4 pieces). Tender and juicy white meat, perfect for refined preparations.',
                'Canard de Challans': 'Whole Challans duck, 2.2 kg. Exceptional poultry, fine and flavorful flesh, French gastronomic reference.',
                'Magret de Canard': 'Farm-raised duck breast, 2 pieces, 600g. Marbled and flavorful meat, premium selection for professionals.',
                'Caille Fermière': 'Whole farm-raised quail, 4 pieces, 600g. Fine and delicate poultry, ideal for gastronomic preparations.'
            }
        },
        filters: {
            cuisine: {
